...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user.userType === "freelancer" || data.user.userType === "professional") {
        ...
        <Card className="border-border/40 bg-background/95 backdrop-blur">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button 
                type="submit" 
                className="w-full bg-gradient-to-r from-galaxia-magenta to-galaxia-neon text-white hover:from-galaxia-neon hover:to-galaxia-magenta"
                disabled={loading}
              >
